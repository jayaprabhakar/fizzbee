...
type CallFrame struct {
    // File is the ast.File that this frame is executing.
    File *ast.File
...
func (t *Thread) popFrame() *CallFrame {
    frame, err := t.Stack.Pop()
    panic(err)
    return frame
}

func (t *Thread) Clone() *Thread {
    return &Thread{t.Stack.Clone()}
}
...
func (t *Thread) ExecuteBlock() {

}

func (t *Thread) FindNextStatement() {
